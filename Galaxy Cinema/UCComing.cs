...
{
    public partial class UCComing : UserControl
    {
        public UCComing()
        {
            InitializeComponent();
        ...
        private void UCComing_Load(object sender, EventArgs e)
        {
            panel22.BackColor = Color.FromArgb(244, 209, 0);
            panel21.BackColor = Color.FromArgb(25, 30, 48);
        }
    }
}
